...
public class ConfigError {
    private static String CONFIG = "<<<<< ConfigError";

    /** The logger. */
    private static Logger logger= LogManager.getLogger(ConfigError.class);
    ...
    private static final class InstanceHolder {
        ...
        private static final ConfigError INSTANCE = new ConfigError();
    ...
    public static ConfigError getInstance() {
    ...
    public void loadConfigurations() {
        ...
        if (serverName != null && !serverName.isEmpty()) {
            finalPath = basePath + "/" + serverName + "/" + Constant.ERROR_CONFIG_FILE;
        }
        else {
            finalPath = basePath + "/" + Constant.ERROR_CONFIG_FILE;
        }
